...
export default function SecteursCreatifsPage() {
  ...
  const jsonLd = {
    ...
    '@type': 'Service',
    '@id': 'https://www.mariusia.com/secteurs-creatifs',
    name: 'Conseil IA pour Industries Créatives - Marius IA',
    description: 'Ateliers créatifs IA, sécurité juridique, laboratoire d\'innovation, monétisation pour les industries créatives.',
    provider: {
      '@type': 'Organization',
    ...
    serviceType: ['Creative AI Consulting', 'Legal Advisory', 'Innovation Labs'],
  }

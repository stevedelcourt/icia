...
const offres = [
  { num: '01', title: 'Diagnostic IA & AI Act', tagline: 'Porte entree universelle', duration: '4-6 semaines', description: "En 4 a 6 semaines, vous savez exactement ou vous en etes, ou vous pouvez aller, et ce que l'AI Act vous impose concretement - avec une feuille de route prete a executer.", href: '/offres/diagnostic' },
  { num: '02', title: 'Formations & Acculturation', tagline: 'Intra-entreprise', duration: 'Parcours sur mesure', description: "Vos equipes utilisent deja l'IA, souvent sans le savoir, parfois sans securite. On fait en sorte qu'elles le fassent bien, dans un cadre securise.", href: '/offres/formations' },
  { num: '03', title: 'Transformation IA', tagline: 'Accompagnement 6-12 mois', duration: '6-12 mois', description: "On vous aide a faire passer l'IA de l'experimentation a la pratique quotidienne - sans casser votre organisation, avec des resultats mesurables.", href: '/offres/transformation' },
  { num: '04', title: 'Partenaire IA Mensuel', tagline: 'Abonnement', duration: 'Engagement 12 mois', description: "Un partenaire independant pour vous aider a decider sur l'IA, en continu - veille, conseil, arbitrage, alerte reglementaire.", href: '/offres/partenaire' },
]
          ...
          <div className="max-w-6xl mx-auto px-8">
            <div className="grid lg:grid-cols-2 gap-20 items-start">
              ...
              >
                ...
                <h1 className="text-5xl md:text-6xl font-serif font-bold text-black leading-[1.1] mb-8">
                  Nous ne vendons<br />
                  pas de l'IA.
                </h1>
        ...
        <section id="piliers" className="py-16 md:py-20 border-b border-gray-200" style={{ backgroundColor: '#f9f7f3' }}>
          <div className="max-w-6xl mx-auto px-8">
            <div className="text-center mb-16">
              ...
              <h2 className="text-4xl md:text-5xl font-serif font-bold text-black">Nos 3 piliers</h2>
            </div>
            <div className="grid md:grid-cols-3 gap-8">
              {piliers.map((p, i) => (
                ...
                >
                  <h3 className="text-2xl font-serif font-bold text-black mb-4">{p.title}</h3>
        ...
        <section id="offres" className="py-16 md:py-20 border-b border-gray-200" style={{ backgroundColor: '#aebddb' }}>
          <div className="max-w-6xl mx-auto px-8">
            <div className="text-center mb-16">
              ...
              <h2 className="text-4xl md:text-5xl font-serif font-bold text-black">Offres pour entreprises</h2>
                ...
                >
                  <Link href={offre.href} className="flex justify-between items-start py-10 border-b border-gray-100 last:border-b-0 group hover:bg-gray-50 transition-all duration-200">
                    <div className="flex items-start gap-10 max-w-3xl">
                      ...
                      <div>
                        <h3 className="text-2xl font-serif font-bold text-black mb-2 group-hover:text-gray-600 transition-colors duration-200">{offre.title}</h3>
        ...
        <section id="acteurs" className="py-16 md:py-20 border-b border-gray-200" style={{ backgroundColor: '#f9f7f3' }}>
          <div className="max-w-6xl mx-auto px-8">
            <div className="text-center mb-16">
              ...
              <h2 className="text-4xl md:text-5xl font-serif font-bold text-black">Nos acteurs</h2>
              ...
              {acteurs.map((acteur, i) => (
                ...
                >
                  <Link href={acteur.href} className="group block p-8 bg-white border border-gray-200 hover:border-gray-400 hover:shadow-xl transition-all duration-200 h-full">
                    <h3 className="text-xl font-serif font-bold text-black mb-3 group-hover:text-gray-600 transition-colors duration-200">{acteur.title}</h3>
        ...
        <section id="partenaires" className="py-20 border-b border-gray-200 overflow-hidden">
          <div className="max-w-6xl mx-auto px-8">
            <div className="text-center mb-16">
              ...
              <h2 className="text-4xl md:text-5xl font-serif font-bold text-black">Ils nous font confiance</h2>
            </div>
        ...
        <section id="contact" className="py-20" style={{ backgroundColor: '#1a1a1a' }}>
          <div className="max-w-4xl mx-auto px-8 flex items-center gap-12">
            <div className="flex-1 text-center">
              ...
              <h2 className="text-4xl md:text-5xl font-serif font-bold text-white mb-6">Pret a vous lancer ?</h2>

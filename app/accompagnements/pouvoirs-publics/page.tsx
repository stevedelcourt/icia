      ...
      <main id="main-content">
        ...
        <div className="pt-20 border-b border-white/5 bg-slate-dark">
          <div className="max-w-6xl mx-auto px-4 md:px-8 py-3 flex items-center gap-2 text-sm text-white/40">
            ...
            <span>/</span>
            <span className="text-white/80 font-medium">Pouvoirs publics</span>
          </div>
        ...
        <section className="relative bg-slate-dark overflow-hidden">
          <div className="absolute inset-0 opacity-40" style={{ background: 'radial-gradient(ellipse at 20% 50%, rgba(107,122,139,0.2) 0%, transparent 50%)' }} />
            ...
            <div className="grid md:grid-cols-2 gap-0">
              ...
              <div className="border-l border-white/5 py-16 md:py-24 pl-8 flex flex-col justify-center relative overflow-hidden">
                <FadeIn delay={0.1}>
                  ...
                  <p className="text-white/40 mb-8 max-w-xs">régions couvertes par l'observatoire territorial ICIA</p>
        ...
        {/* Stats */}
        <div className="grid md:grid-cols-4 border-b border-white/5">
          ...
          <div className="p-8 border-r border-white/5 bg-slate-medium">
            ...
            <p className="text-white/40 text-sm">régions dans l'observatoire</p>
          </div>
          <div className="p-8 border-r border-white/5 bg-slate-medium">
            <div className="text-4xl md:text-5xl font-bold mb-2 text-ivory-light">
              <span style={{ color: accentColor }}>50+</span>
            </div>
            <p className="text-white/40 text-sm">indicateurs territoriaux</p>
          </div>
          <div className="p-8 bg-slate-medium">
            <div className="text-4xl md:text-5xl font-bold mb-2 text-ivory-light">
              <span style={{ color: accentColor }}>0€</span>
            </div>
            <p className="text-white/40 text-sm">pour les collectivités éligibles</p>
          </div>
        </div>
        ...
        <Section id="programmes" className="bg-slate-dark border-t border-white/5">
          <FadeIn>
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-12 text-ivory-light">Quatre axes pour<br />les pouvoirs publics</h2>
          </FadeIn>
          <Stagger>
        ...
        {/* Observatoire */}
        <div className="bg-slate-medium border-t-2" style={{ borderColor: accentColor }}>
          <div className="max-w-6xl mx-auto px-4 md:px-8 py-16">
            <div className="grid md:grid-cols-2 gap-12 items-start">
              <div>
                <div className="inline-flex items-center gap-3 text-xs font-semibold tracking-widest uppercase mb-4 text-white/50">
                  <span className="w-6 h-px bg-white/30"></span>
                  Observatoire territorial
                </div>
                <h2 className="text-3xl md:text-4xl font-bold mb-4 text-ivory-light">Le pouls de l'IA<br />dans les territoires</h2>
              ...
              <div className="grid grid-cols-3 gap-px bg-white/5">
                <div className="p-6 bg-slate-dark/50 hover:bg-slate-dark transition-colors">
                  <div className="text-3xl md:text-4xl font-bold mb-1 text-ivory-light">
                    <span style={{ color: accentColor }}>50</span>+
                  </div>
        ...
        <Section className="bg-slate-medium">
          <FadeIn>
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-12 text-ivory-light">Un accompagnement<br />respectueux de vos contraintes</h2>
          </FadeIn>
          <Stagger>
        ...
        <Section className="bg-slate-dark">
          <FadeIn>
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-8">
              <div>
                <h2 className="text-3xl md:text-4xl font-bold mb-3 text-ivory-light">Parlons de votre projet</h2>
